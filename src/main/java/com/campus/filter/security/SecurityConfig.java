package com.campus.filter.security;
...
public class SecurityConfig {
    ...
    SecurityFilterChain securityFilterChain(HttpSecurity http, JWTValidationFilter jwtValidationFilter)
        ...
        http.authorizeHttpRequests(auth -> auth
                    .requestMatchers("/users/", "/properties/", "/offices/", "/visits/").hasAnyRole("USER", "ADMIN")
                    .requestMatchers("/users/**", "/properties/**", "/offices/**", "/visits/**").hasRole("ADMIN")
